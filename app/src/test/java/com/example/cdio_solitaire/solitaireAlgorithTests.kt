...
class SolutionUnitTest {
    ...
    fun contest(){
        val solitaireSolver = SolitaireSolver()
        val bottom_column1: MutableList<Card> = mutableListOf(Card(3,"C",false),Card(4,"H",false),Card(5,"C",false),Card(6,"H",false),Card(7,"C",false),Card(8,"H",false),Card(9,"S",false),Card(10,"D", false))
        val bottom_column2: MutableList<Card> = mutableListOf(Card(4,"C", false),Card(5,"H",false),Card(6,"C", false))
        val bottom_column3: MutableList<Card> = mutableListOf(Card(6,"S",false),Card(7,"H", false),Card(null,null, true))
        val bottom_column4: MutableList<Card> = mutableListOf(Card(10,"S", false),Card(null,null, true))
        val bottom_column5: MutableList<Card> = mutableListOf(Card(11,"S", false),Card(null,null, true),Card(null,null, true))
        val bottom_column6: MutableList<Card> = mutableListOf(Card(12,"S", false),Card(null,null, true),Card(null,null, true),Card(null,null, true))
        val bottom_column7: MutableList<Card> = mutableListOf(Card(10,"H",false),Card(11,"C", false),Card(null,null, true),Card(null,null, true),Card(null,null, true),Card(null,null, true),Card(null,null, true))

        val top_column1: MutableList<Card> = mutableListOf(Card(3,"H",false),Card(2,"H",false),Card(1,"H",false))
        val top_column2: MutableList<Card> = mutableListOf(Card(1,"C",false))
        val top_column3: MutableList<Card> = mutableListOf(Card(2,"D", false),Card(1,"D",false))
        val top_column4: MutableList<Card> = mutableListOf(Card(2,"S",false),Card(1,"S", false))

        solitaireSolver.updateTalon(4,"S")
