...
class SolutionUnitTest {
    ...
    fun contest(){
        ...
        val bottom_column2: MutableList<Card> = mutableListOf()
        val bottom_column3: MutableList<Card> = mutableListOf()
        val bottom_column4: MutableList<Card> = mutableListOf()
        val bottom_column5: MutableList<Card> = mutableListOf()
        val bottom_column6: MutableList<Card> = mutableListOf()
        val bottom_column7: MutableList<Card> = mutableListOf()

        val top_column1: MutableList<Card> = mutableListOf(Card(13,"S",false),Card(12,"S", false),Card(11,"S", false),Card(10,"S",false),Card(9,"S",false),Card(8,"S",false),Card(7,"S",false),Card(6,"S",false),Card(5,"S", false),Card(4,"S", false),Card(3,"S", false),Card(2,"S", false),Card(1,"S",false))
