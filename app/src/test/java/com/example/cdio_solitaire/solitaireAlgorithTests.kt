...
class SolutionUnitTest {
    ...
    fun contest(){
        ...
        val top_column1: MutableList<Card> = mutableListOf(Card(12,"S", false),Card(11,"S", false),Card(10,"S",false),Card(9,"S",false),Card(8,"S",false),Card(7,"S",false),Card(6,"S",false),Card(5,"S", false),Card(4,"S", false),Card(3,"S", false),Card(2,"S", false),Card(1,"S",false))
